			...
			spellCastSuccess = {
				...
				args = {
					...
					shaman	= {
						...
						name = "|cff0070DEShaman|r",
						order = 7,
						args = listOption({1108143,1116190,1102484,1108177,1132182,1102825},"castSuccess"),
					},
					mage = {
						type = 'group',
						inline = true,
					...
					hunter = {
						...
						name = "|cffABD473Hunter|r",
						order = 10,
						args = listOption({1153271,1123989,1119386,1134490,1149050,1114311,1113810},"castSuccess"),
					},
					warlock = {
						type = 'group',
						inline = true,
